...
const DetailShopWoman = () => {
  const { id } = useParams();
  const navigate = useNavigate(); // Hook for back navigation
  const { addToCart } = useContext(CartContext);
  
  // Find product safely
  const product = Product_woman.find(p => p.id === parseInt(id));
  ...
  const handleAddtoCart = () => {
    // Pass the specific quantity and size selected by the user
    addToCart({ 
      ...product, 
      quantity: qty, 
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="w-full">
           {/* Sticky allows image to stay in view while scrolling details on large screens */}
          <div className="md:sticky md:top-24">
            <div className="aspect-[3/4] w-full bg-gray-100 rounded-lg overflow-hidden relative shadow-sm">
              <img
        ...
        <div className="flex flex-col pt-2">
          ...
          <div className="prose prose-sm text-gray-500 mb-8">
            <p>
              ...
              Made from high-quality cotton for maximum comfort.
            </p>
            <p className="text-xs text-gray-400 mt-2">Product Code: 21252081351</p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 text-center">
            <div className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg">
              <svg className="w-6 h-6 mb-2 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" /></svg>
              <span className="text-sm font-medium text-gray-900">Fast Delivery</span>
            </div>
            <div className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg">
              <svg className="w-6 h-6 mb-2 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
...
export default DetailShopWoman;