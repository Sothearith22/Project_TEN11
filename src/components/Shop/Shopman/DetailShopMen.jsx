      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="w-full">
          ...
          <div className="md:sticky md:top-24">
            <div className="aspect-[3/4] w-full bg-gray-100 rounded-lg overflow-hidden shadow-sm relative">
              <img
        ...
        <div className="flex flex-col pt-2">
          ...
          <div className="prose prose-sm text-gray-500 mb-8">
            <p>
              Premium quality men's apparel designed for comfort and style. 
              Perfect for casual outings or smart-casual events.
            </p>
            <p className="text-xs text-gray-400 mt-2">Product Code: {product.id}MEN2026</p>
          </div>
